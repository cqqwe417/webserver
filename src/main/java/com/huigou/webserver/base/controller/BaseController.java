package com.huigou.webserver.base.controller;
...
import com.huigou.webserver.base.model.Response;
import com.huigou.webserver.common.BusinessException;
import com.huigou.webserver.entity.WiUser;
import com.huigou.webserver.exception.BizException;
import com.huigou.webserver.utils.Constants;
import com.huigou.webserver.utils.StringUtil;
import com.huigou.webserver.utils.SystemUtil;
...
public class BaseController {
	...
	* @throws
	...
	protected WiUser getLoginEmployeeInfo(HttpSession session) {
		Object object = session.getAttribute(Constants.LOGIN_SESSION);
		if(object != null){
			return (WiUser) object;
		}else{
			return null;
		}
	}
