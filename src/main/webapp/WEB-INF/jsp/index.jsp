...
<!--         <h1 style="margin:0;padding:15px;cursor:default;font-family:微软雅黑,黑体,宋体;">DBM系统 </h1>
 -->                <h1 style="padding:15px; text-align:center; cursor:default;font-family:微软雅黑,黑体,宋体;">经纪人后台管理系统&nbsp;V${version} </h1>
       <div style="position:absolute;top:18px;right:10px;">
       		<span>欢迎您：<span id="username"></span></span>
       		<a id="logoff" class="mini-button mini-button-iconTop"  onclick="logOff();"  plain="true" >注销</a>
	...
	<script type="text/javascript">
		$(function(){
			debugger;
			var url = "${mainPage}";
			lf.huigouserver.index.init(url);
		});
	</script>
</html>
