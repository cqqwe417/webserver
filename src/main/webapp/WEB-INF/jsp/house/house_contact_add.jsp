            ...
            <table style="table-layout:fixed;padding-top: 20px;">
                   <tr>  
                    ...
                    <td style="width:160px;">    
                        <input name="hostMobile" id="hostMobile" onvalidation="isMobile" value="${hostMobile }" class="mini-textbox"   required="true"/>
                    </td>
                    </tr>
                    <tr>
					<td></td>
    ...
    <script type="text/javascript">
        ...
        function SaveData() {
            ...
            $.ajax({
                ...
                data: {'houseId':'${houseId}','hostName':hostName,'hostMobile':hostMobile},
				type: 'post',
                dataType:'json',
                cache: false,
