            ...
            <table style="table-layout:fixed;padding-top: 20px;">
                   <tr>  
                    ...
                    <td style="width:150px;">    
                        <input name="agentStore" url="houseResource/sell/getStoreListByHouseId.do?houseId=${houseId }"  class="mini-combobox" valueField="id" textField=text required="true" onvaluechanged="onStoreChanged"
                         />
                    </td>
                    </tr>
                    <tr>
                    ...
                    <td style="width:160px;">    
                        <input name="name" class="mini-combobox" valueField="id" textField="text" url="houseResource/sell/getAgentListByStoreId.do?storeId=${id }&houseId=${houseId}"  required="true"
                         emptyText="请选择人员"/>
                    </td>
            </table>
        </div>
    ...
    <script type="text/javascript">
       ...
       /*  if('${id}'!=0){
        ...
        function SaveData() {
            ...
            $.ajax({
                url: "houseResource/sell/saveUpdateAgent.do?houseId=${houseId}&houseAgentId="+houseAgentId+"&flag=${flag}",
				type: 'post',
                dataType:'json',
                cache: false,
